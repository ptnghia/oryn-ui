...
{{-- Usage: <x-oryn-block-page-maintenance /> --}}
@props([
        ...
        <div class="container mx-auto flex flex-col flex-auto items-center justify-center min-w-0 h-full">
            <div class="min-w-[320px] md:min-w-[500px] max-w-[500px]">
                <div class="text-center">
                    ...
                    @else
                        <div class="mb-10 flex justify-center">
                            <svg class="w-[200px] h-[200px] text-gray-300 dark:text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.5" stroke="currentColor">
