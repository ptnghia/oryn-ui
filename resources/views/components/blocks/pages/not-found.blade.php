{{-- Not Found (404) Block --}}
{{-- Usage: <x-oryn-block-page-not-found /> --}}
@props([
    'title' => 'Oops! Page not found',
    'message' => 'This page does not exist or has been removed. We suggest you go back to the home page.',
    'homeUrl' => '/',
        ...
        <div class="container mx-auto flex flex-col flex-auto items-center justify-center min-w-0 h-full">
            <div class="min-w-[320px] md:min-w-[500px] max-w-[500px]">
                <div class="text-center">
                    ...
                    @else
                        <div class="mb-10 flex justify-center">
                            <div class="text-[120px] font-bold text-gray-200 dark:text-gray-700 leading-none">404</div>
                        </div>
                    @endif
