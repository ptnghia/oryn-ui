...
**Trạng thái**: 🔄 In Progress — Milestone 1 ✅ / Milestone 2 ✅ / Milestone 3 ✅ / Milestone 4 ✅
...
### Build Pipeline
- [x] Custom `docs:export` Artisan command (replaces `spatie/laravel-export`)
- [x] Generate static HTML từ doc routes (79 pages)
- [x] Deploy to GitHub Pages (via GitHub Actions)
- [ ] Custom domain setup (nếu có)

### GitHub Actions
- [x] Workflow: build docs on push to `main` (`.github/workflows/deploy.yml`)
- [x] Deploy to GitHub Pages (using `actions/deploy-pages@v4`)
- [ ] Versioned docs (v1, v2, etc.)

### SEO
- [x] Meta tags cho mỗi page (title, description, canonical, OG, Twitter)
- [ ] Open Graph images (per-page generation)
- [x] Sitemap.xml (auto-generated by export command)
- [x] robots.txt (auto-generated by export command)
...
- [x] Static build thành công (79/79 pages, 5.8MB)
- [ ] Deploy pipeline hoạt động (workflow created, needs GitHub Pages enabled)
